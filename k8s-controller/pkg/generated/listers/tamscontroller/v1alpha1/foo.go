...
type FooLister interface {
	...
	List(selector labels.Selector) (ret []*tamscontrollerv1alpha1.Foo, err error)
...
type fooLister struct {
	listers.ResourceIndexer[*tamscontrollerv1alpha1.Foo]
}

// NewFooLister returns a new FooLister.
func NewFooLister(indexer cache.Indexer) FooLister {
	return &fooLister{listers.New[*tamscontrollerv1alpha1.Foo](indexer, tamscontrollerv1alpha1.Resource("foo"))}
}

// Foos returns an object that can list and get Foos.
func (s *fooLister) Foos(namespace string) FooNamespaceLister {
	return fooNamespaceLister{listers.NewNamespaced[*tamscontrollerv1alpha1.Foo](s.ResourceIndexer, namespace)}
}
...
type FooNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*tamscontrollerv1alpha1.Foo, error)
